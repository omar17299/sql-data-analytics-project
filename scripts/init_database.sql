...
OPTION (B)
----------------
There is a file called 'datasets' containing all the data you gonna need from all layers (before and after cleansing & transormation)
=============================================================
Script Purpose:
